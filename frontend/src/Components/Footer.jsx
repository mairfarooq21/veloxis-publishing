...
const Footer = () => {
  return (
    <div className="relative mt-[-200px] pt-[300px] z-[1] bg-cover bg-center bg-no-repeat px-[10%]"
      style={{ backgroundImage: `url(${FooterBg})`}}>
      <div className="flex flex-wrap justify-between border-t border-white/10 text-white">
        {/* Logo Section */}
        ...
        <div className="flex-1 min-w-[220px] mb-8">
          ...
          <ul className="ml-6 space-y-2 text-sm text-[#d1d1d1]">
        ...
        <div className="flex-1 min-w-[220px] mb-8">
          ...
          <p className="text-[#d1d1d1] text-sm my-4 w-[80%]">Phone: (870) 233–9799</p>
          <p className="text-[#d1d1d1] text-sm my-4 w-[80%]">Email: Info@veloxispublishing.com</p>
          <p className="text-[#d1d1d1] text-sm my-4 w-[80%]">Address: 2200 Meadowlake Rd, Conway AR 72032</p>
        ...
        {/* Newsletter */}
        <div className="flex-1 min-w-[220px] mb-8 text-[#d1d1d1] text-sm">
      ...
      {/* Footer Bottom */}
      <div className="text-center py-5 text-[#a1a1a1] text-sm bg-[#0a0a0a]">
