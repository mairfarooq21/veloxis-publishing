  ...
  return (
    <header className="flex justify-between items-center px-5 py-5 mb-[-119px]">
      ...
      <div className="p-[1.75px] rounded-full bg-gradient-to-r from-[#1BBED3] to-[#2E2A7A] inline-block">
        <a
          href="tel:8703339799"
          className="text-white bg-gradient-to-r from-[#2E2A7A] to-[#1BBED3] px-[22px] py-[11px] flex items-center justify-center rounded-full font-[600] no-underline text-[16px] bg-clip-padding"
        >
          <img
            src={Phone}
            alt="Call Icon"
