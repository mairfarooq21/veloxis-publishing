    ...
    <section className="bg-gradient-to-r from-[#2e2a7a] to-[#1bbed3] py-[45px] px-5 text-white font-poppins flex justify-center items-center">
      <div className="w-[80%] flex justify-center items-center gap-[30px]">
        ...
        <div className="flex flex-col w-[30%]">
          <h2 className="text-[30px] font-bold mb-[10px]">Get your Quote Today</h2>
          <p className="text-[18px] mt-[-10px] leading-[1.6] text-[#e2e2e2]">
        ...
        <div className="flex flex-col items-center gap-[15px] w-[40%]">
          <div className="flex gap-[25px]">
            <input type="text" className="quote-input p-3 w-[240px]" placeholder="Full Name" />
            <input type="text" className="quote-input p-3 w-[240px]" placeholder="Phone Number" />
          </div>
          <div className="flex gap-[25px]">
            <input type="email" className="quote-input p-3 w-[240px]" placeholder="Email" />
            <select className="quote-input p-3 text-[#8f8f8f] w-[240px]">
        ...
        <div className="flex flex-col gap-[20px] items-start w-[30%]">
