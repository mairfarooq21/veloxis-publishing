        ...
        <div className="flex justify-between items-center w-full mt-11">
          ...
          <div className="w-[50%] flex justify-end pl-10">
            <div className="w-[745px]">
              <span className="gradient-border relative inline-block !text-white mb-2 px-[30px] py-[8px] rounded-full z-10 border-[#1bcdfc] border-[2px]">
              ...
              <div className="flex flex-row mb-8 gap-4">
                <a
                  href="#"
                  className="gradient-border !text-white bg-gradient-to-r from-[#2E2A7A] to-[#1BBED3] !px-[36px] !py-[11px] flex items-center justify-center rounded-full font-[600] no-underline text-[16px] bg-clip-padding hover:!text-black transition-colors duration-300 hover:from-[white] hover:to-[white]"
                >
                  Let’s Get Started
                </a>
                <a
                  href="#"
                  className="gradient-border text-black bg-gradient-to-r from-[white] to-[white] border-[2px] border-[white] px-[26px] py-[11px] flex items-center justify-center rounded-full font-[600] no-underline text-[16px] bg-clip-padding hover:!text-white hover:bg-gradient-to-r hover:from-[#2E2A7A] hover:to-[#1BBED3]"
                >
                  Live Chat
                </a>
              </div>
